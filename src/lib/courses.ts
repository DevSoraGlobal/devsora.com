    ...
    modules: [
        {
            ...
            topics: parseTocToTopics(jsFundamentalsToc).slice(0, 5)
        },
        {
            title: 'Module 2: Data Structures & DOM',
            topics: parseTocToTopics(jsFundamentalsToc).slice(5, 11)
        },
        {
            title: 'Module 3: Advanced & Modern JS',
            topics: parseTocToTopics(jsFundamentalsToc).slice(11)
        }
    ]
  },
  {
