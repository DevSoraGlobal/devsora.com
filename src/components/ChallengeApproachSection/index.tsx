      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="flex flex-col gap-12">
            <div>
              <h2 className="text-base font-semibold leading-7 text-primary font-headline tracking-[0.08em]">Our Mission</h2>
              <p className="mt-2 text-3xl font-bold text-foreground sm:text-4xl font-headline tracking-[0.08em]">The Challenge</p>
            ...
            <div>
              <p className="mt-2 text-3xl font-bold text-foreground sm:text-4xl font-headline tracking-[0.08em]">The Approach</p>
              <p className="mt-6 text-muted-foreground font-medium tracking-body">
          ...
          <div className="min-h-[480px] hidden">
            <iframe 
