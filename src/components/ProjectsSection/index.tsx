                      ...
                      <CardContent className="p-6 flex-grow flex flex-col justify-between">
                        ...
                        <Dialog>
                          <DialogTrigger asChild>
                            <Button variant="link" className="p-0 h-auto mt-4 self-start tracking-body">More Details</Button>
                          </DialogTrigger>
                          <DialogContent className="sm:max-w-[600px] bg-background">
                            <DialogHeader>
                              ...
                              <DialogTitle className="text-2xl font-headline mt-4 tracking-heading">{project.title}</DialogTitle>
                            ...
                            <div className="flex justify-end gap-2 mt-4">
                               <Link href="/explore" passHref>
                                <Button variant="outline" className="tracking-body">Explore More Projects</Button>
                               </Link>
                               <Button className="tracking-body">View Source</Button>
                            </div>
                          </DialogContent>
                        </Dialog>
                      </CardContent>
